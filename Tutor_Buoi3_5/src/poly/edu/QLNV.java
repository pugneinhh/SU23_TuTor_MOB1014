...
//-	TimTheoKhoangLuong()
    public void timTheoKhoangLuong(){
     ...
     public void fakeData(){//Thêm 5 phần tử vào list.
         lstNhavien.add(new NhanVien("NV001", "Lê Xuân Lý", 5000));
         lstNhavien.add(new NhanVien("NV002", "Lê Xuân Lâm", 1000));
         lstNhavien.add(new NhanVien("NV003", "Lê Xuân Liên", 3000));
         lstNhavien.add(new NhanVien("NV004", "Lê Thu Lan", 4000));
         lstNhavien.add(new NhanVien("NV005", "Trần Thu Hà", 5000));
     }
}
